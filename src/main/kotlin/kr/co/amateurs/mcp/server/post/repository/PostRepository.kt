...
class PostRepository(
    ...
    fun findAll(params: PostSearchParams): Page<PostResponseDTO> = executeQuery(params)

    private fun executeQuery(params: PostSearchParams): Page<PostResponseDTO> {
    ...
    private fun buildConditions(params: PostSearchParams): Condition {
        ...
        params.keyword.let { keyword ->
            condition = condition
                .or(POSTS.TITLE.like("%$keyword%"))
                .or(POSTS.CONTENT.like("%$keyword%"))
                .or(POSTS.TAG.like("%$keyword%"))
        }
